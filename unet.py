# unet.py
# -----------------------------------------------------------------------------
# A compact U-Net for DDPMs with optional class conditioning.
# - Uses sinusoidal timestep embeddings
# - Optional class embedding with an extra "null" class (for CFG/uncond passes)
# - Residual blocks conditioned on [time || class] via a small MLP
# - Encoder downsamples by AvgPool2d; decoder upsamples by ConvTranspose2d
# -----------------------------------------------------------------------------
